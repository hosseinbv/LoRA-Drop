...
class Qwen2_Lora_DropMLP(LlamaMLP):
...
class Qwen2_Lora_DropAttention(LlamaAttention):
...
if version.parse(get_torch_version()) >= version.parse("2.3.0"):
    ...
    class Qwen2_Lora_DropRMSNorm(nn.RMSNorm):
...
class Qwen2_Lora_DropDecoderLayer(LlamaDecoderLayer):
    def __init__(self, config: Qwen2_Lora_DropConfig, layer_idx: int):
        super().__init__(config=config, layer_idx=layer_idx)
        self.attention_type = config.layer_types[layer_idx]


class Qwen2_Lora_DropPreTrainedModel(LlamaPreTrainedModel):
    pass


class Qwen2_Lora_DropModel(MistralModel):
...
class Qwen2_Lora_DropForCausalLM(LlamaForCausalLM):
    pass


class Qwen2_Lora_DropForSequenceClassification(LlamaForSequenceClassification):
    pass


class Qwen2_Lora_DropForTokenClassification(LlamaForTokenClassification):
    pass


class Qwen2_Lora_DropForQuestionAnswering(LlamaForQuestionAnswering):
    pass
